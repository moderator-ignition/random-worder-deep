local UILibrary = {}
--// Modules
--//If you were able to find this most likely you are pretty smart, proud of you. - C8
--//Closer to reversing this script!!!!!
...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Image.Image = "rbxassetid://9011713775"
            ...
            Gui.Watermark.Text = "Annox | nil | nil"
            ...
            Gui.Logo.ZIndex = 122
            Gui.Logo.Image = "rbxassetid://4877672499"
...
function UILibrary.new(gameName, userId, rank)
    ...
    --// Customize the GUI
    window.Watermark.Text = ("Annox | %s | %s"):format(userId, gameName)
